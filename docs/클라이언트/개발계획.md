...
1. **컨텐츠 연동 시스템**
   - [ ] 노트 기반 노드 생성 ([노트 기본 기능 구현](../기획/[Synaptic]기능요구사항.md#3-학습-노트-시스템)
     - 노트 작성 시 자동 노드 생성
     - 태그 기반 노드 분류
     - 참조 기반 연결 생성
   - [ ] 블로그 포스트 연동
...
### 1. **노트 기본 기능**
  - 개발전 상세 계획
    - [노트 기본 구조 설계](/apps/client/src/components/notes/shared/NoteTypes.ts)
    - 필요한 컴포넌트 구조
      - NoteList/
        - NoteList.tsx        <!-- 노트 목록 표시 -->
        - NoteCard.tsx        <!-- 노트 카드 표시 --> 
        - Notefilters.tsx     <!-- filter, sort control -->
      - NoteEditor/
        - NoteEditor.tsx      <!-- 노트 작성/편집 --> 
        - NoteToolbar.tsx     <!-- 노트 작성 도구모음 --> 
    ...
    - 개발 순서
      ...
      - [x] 노트 목록 표시 기능
        - NoteList Components
        - NoteFilters Components
      - [x] 노트 생성/편집 기능
        - NoteEditor compoents
        - NoteTags components
      - 태그 시스템 구현
      - 마크다운 에디터 통합
